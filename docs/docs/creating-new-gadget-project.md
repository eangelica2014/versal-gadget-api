---
id: creating-new-gadget-project
title: Creating a new gadget project
---
...
The gadget communicates with the course player via events sent over a `postMessage` based event bus.

### Basic functions of the gadget API
